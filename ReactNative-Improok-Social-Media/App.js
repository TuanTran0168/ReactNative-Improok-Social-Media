...
import MyAccountReducer from "./src/reducers/MyAccountReducer";
...
import EditPost from './src/layouts/EditPost';
...
export default function App() {
  ...
  const [account, accountDispatch] = useReducer(MyAccountReducer, AsyncStorage.getItem("account") || null)
  return (
    <MyUserContext.Provider value={[user, dispatch]}>
      <MyAccountContext.Provider value={[account, accountDispatch]}>
        <NativeBaseProvider>
          <PopupRootProvider>
            <NativeRouter>
              <NavigationContainer>
